  <aside class="main-sidebar">
      <section class="sidebar">
          <ul class="sidebar-menu" data-widget="tree">
              ...
              <?php if ($this->session->userdata('uroleid') == SUPERUSER) { ?>
              <li
                  class="<?php echo ($this->uri->segment(2) == 'student' or $this->uri->segment(2) == 'class' or $this->uri->segment(2) == 'majors' or $this->uri->segment(2) == 'period' or $this->uri->segment(2) == 'setting' or $this->uri->segment(2) == 'month') ? 'active' : '' ?> treeview">
                  <a href="#">
