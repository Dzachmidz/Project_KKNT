...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('manage/pos') ?>">Nama Pembayaran</a></li>
				...
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input name="pos_name" type="text" class="form-control" value="<?php echo $inputNameValue ?>" placeholder="Nama Pembayaran">
						</div>
			...
			<div class="col-md-3">
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<a href="<?php echo site_url('manage/pos'); ?>" class="btn btn-block btn-info"><i class="fa fa-repeat"></i> Batal</a>
						<?php if (isset($pos['pos_id'])) { ?>
							<a href="#delModal<?php echo $pos['pos_id']; ?>" data-toggle="modal" class="btn btn-block btn-danger"><i class="fa fa-close"></i> Hapus</a>
						<?php } ?>
					</div>
					<!-- /.box-body -->
				</div>
