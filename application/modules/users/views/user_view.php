				...
				<div class="box box-success">
					<div class="box-body box-profile">
						...
						<?php if ($this->session->userdata('uid') != $user['user_id']) { ?>
							...
							<a href="<?php echo site_url('manage/users/rpw/' . $user['user_id']) ?>" class="btn btn-success btn-block"><i class="fa fa-refresh"></i> <b>Reset Password</b></a>
			...
			<div class="col-md-8">
				...
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<a href="<?php echo site_url('manage/users/edit/' . $user['user_id']) ?>" class="btn btn-success"><i class="fa fa-edit"></i> <b>Edit</b></a>
					</div>
					<!-- /.box-body -->
				</div>
				<!-- /.box -->
